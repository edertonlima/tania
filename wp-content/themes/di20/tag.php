			...
			<?php
				...
				while ( have_posts() ) : the_post();
					...
					if($item_blog == 1){
						...
						<?php /*<div class="busca-post box-select">
							<div class="select">
						...
						<form role="search" method="get" class="search-form" action="<?php echo home_url( '/' ); ?>">
							<input type="search" class="search-field" placeholder="<?php echo esc_attr_x( 'Encontre o assunto que você quer ler…', 'placeholder' ) ?>"
							value="<?php echo get_search_query() ?>" name="s"
							title="<?php echo esc_attr_x( 'Encontre o assunto que você quer ler…', 'label' ) ?>" />
